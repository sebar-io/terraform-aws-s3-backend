output "stage_terraform_backend_s3_bucket" {
...
output "stage_terraform_backend_dynamodb_table" {
...
output "prod_terraform_backend_s3_bucket" {
...
output "prod_terraform_backend_dynamodb_table" {
